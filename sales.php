...
<h3 style="font-family:Times New Roman, Times, serif;">Transaction (Stock Out)</h3>

<button class="btn btn-primary btn-sm" id="new_sales"><i class="fa fa-plus"></i> New Transaction</button><br><br>
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
