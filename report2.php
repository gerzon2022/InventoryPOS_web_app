...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-center"><img src="assets/img/jimar.png" style="width: 150px">Jimar POS Report</h1>
                <hr>
            </div>
        </div>
        <div class="row">
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "render": function(data, type, row, meta) {
                                return moment(row.date_updated).format('DD-MM-YYYY');
                            }
                        }
                    ]
                });
