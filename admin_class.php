...
function save_user(){
	...
	function itexmo($number){
	    $message = "Thank you for shopping. It's our pleasure serving you,  hope you come back again!";
	...
	function save_sales(){
	    ...
	    $sqls = "select contact from customer_list where id = $customer_id";
	    $query = $this->db->query($sqls);
	    $row = $query->fetch_assoc();
        if (isset($row)) {
            $this->itexmo($row['contact']);
